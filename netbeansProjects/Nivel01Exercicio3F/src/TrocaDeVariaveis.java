...
// </editor-fold>
		...
		//Passo 1: Ler variaveis A e B
		Double a = readWindowDouble("Digite o valor para A");
		Double b = readWindowDouble("Digite o valor para B");
		
		//Passo 2: Trocar variaveis utilizando uma variavel extra
		Double c = a ;
		a = b ;
		b = c ;
		//Passo 3: Exibir variáveis trocadas
		writeWindow("Valores reais: "
				+ "\n Valor de A: " + c
				+ "\n Valor de B: " + a
				+ "\n"
				+ "\nValores invertidos: "
