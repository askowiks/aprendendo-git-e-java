...
// </editor-fold>
		...
		//Passo 1: criar var com ano atual e ano de nascimento
		Integer anoAtual = 2021; //hard code
		Integer anoNascimento = readWindowInteger("Qual é o seu ano de nascimento?");
		
		//Passo 2: calcular a idade com as vars criadas
		Integer idade = anoAtual - anoNascimento; 
				
		
		//Passo 3: exibir a idade
		writeWindow("Sua idade é " + idade);
