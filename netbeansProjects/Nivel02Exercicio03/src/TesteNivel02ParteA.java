...
public class TesteNivel02ParteA {

	public static void main(String[] args) {
// </editor-fold>
		// Your code starts here
		
		Integer idadePessoaQueQuerEntrar = readWindowInteger("Qual é a sua idade?");
		final Integer IDADE_LIMITE = 18;
		
		if (idadePessoaQueQuerEntrar >= IDADE_LIMITE) {
			writeWindow("Seja bem-vindo ao clube! ֍");
		}
		if (idadePessoaQueQuerEntrar < IDADE_LIMITE) {
			writeWindow("Que pena, você ainda não pode frequentar nosso clube.");
		}
