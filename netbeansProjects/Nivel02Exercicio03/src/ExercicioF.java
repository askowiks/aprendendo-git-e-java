...
e apresentar os valores lidos dispostos em 
ordem crescente. Dica: utilizar tomada de decisão sequencial
e as ideias trabalhadas nos exercícios "g" 
(propriedade distributiva) e "f" (troca de valores) do capítulo 3.
		*/		

Integer numA = readWindowInteger("Digite o valor do número A");
Integer numB = readWindowInteger("Digite o valor do número B");
Integer numC = readWindowInteger("Digite o valor do número C");

String auxMensagem = "EXIBIÇÃO DOS VALORES" 
		+ "\nOrdem original: " + numA + ", " + numB + ", " + numC + "\n"
		+ "Ordem crescente: "; 
	//01	
		if (numA > numB && numB> numC){
			auxMensagem = auxMensagem + numC + ", " + numB + ", " + numA + "\n";
		}
	//02	
		if (numB > numC && numC > numA){
			auxMensagem = auxMensagem + numB + ", " + numC + ", " + numA + "\n";
		}
	//03	
		if (numC > numA && numA > numB){
			auxMensagem = auxMensagem + numB + ", " + numA + ", " + numC + "\n";
		}
	//04	
		if (numC > numB && numB > numA){
		auxMensagem = auxMensagem + numA + ", " + numB + ", " + numC + "\n";
		}
	//05	
	...
	//06	
		...
		auxMensagem = auxMensagem + numC + ", " + numA + ", " + numB + "\n";
		}
	//07	
		if (numA == numB && numB > numC){
		auxMensagem = auxMensagem + numC + ", " + numB + ", " + numA + "\n";
	...
	//09	
		if (numB > numA && numA == numC){
		auxMensagem = auxMensagem + numA + ", " + numC + ", " + numB + "\n";
		}
	//10
		if (numA == numB && numB < numC){
		auxMensagem = auxMensagem + numA + ", " + numB + ", " + numC + "\n";
