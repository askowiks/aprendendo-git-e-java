...
// </editor-fold>
	...
	Integer valor = readWindowInteger("Digite um numero");
	
	Integer sobra = ( valor % 2);
	
		if (sobra == 0) {
			writeWindow("O valor " + valor + " é um número par.");
		
		}
		if (sobra > 0) {
			writeWindow("O valor " + valor + " é um número ímpar");
