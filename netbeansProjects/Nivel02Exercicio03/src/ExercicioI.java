...
Integer a = readWindowInteger("Valor de A");
Integer b = readWindowInteger("Valor de B");
Integer c = readWindowInteger("Valor de C");
Integer d = readWindowInteger("Valor de D");
Integer e = readWindowInteger("Valor de E");
	...
	//E	
		...
		writeWindow("Menor número: " + menor);
		
		writeWindow("Maior número: " + maior);
