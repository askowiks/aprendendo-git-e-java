...
//LER NOTAS
	Double n1 = readWindowDouble("Digite a 1ª nota");
	Double n2 = readWindowDouble("Digite a 2ª nota");
	Double n3 = readWindowDouble("Digite a 3ª nota");
	Double n4 = readWindowDouble("Digite a 4ª nota");
...
//CALCULAR MÉDIA 1
	...
	Double mEx = 0.0;
		...
		if (md1 >= 7) {
			...
			mEx = readWindowDouble("Digite a nota do Exame");
			
			Double md2 = (md1 + mEx) / 2.0;
			
			if (md2 >= 5) {
				mensagem = "Aprovado com Exame.\n"
						+ "Média final: " + md2;				
			}
			else {
				mensagem = "Reprovado";
