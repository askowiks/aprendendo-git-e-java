...
// </editor-fold>
	...
	Integer 
		a = readWindowInteger("Digite o valor de A"),
		b = readWindowInteger("Digite o valor de B"),
		c = readWindowInteger("Digite o valor de C"),
		d = readWindowInteger("Digite o valor de D");

	Double restoA2 = a % 2.0;
	Double restoA3 = a % 3.0;

	Double restoB2 = b % 2.0;
	Double restoB3 = b % 3.0;

	Double restoC2 = c % 2.0;
	Double restoC3 = c % 3.0;

	Double restoD2 = d % 2.0;
	Double restoD3 = d % 3.0;

	String mensagem = "Valoresa divisiveis por 2 & 3\n"
			;
	
		if (restoA2 == 0 && restoA3 == 0) {
			mensagem = mensagem + "a: " + a + "\n";
		}
		if (restoB2 == 0 && restoB3 == 0) {
			mensagem = mensagem + "b: " + b + "\n";
		}
		if (restoC2 == 0 && restoC3 == 0) {
			mensagem = mensagem + "c: " + c + "\n";
		}
		if (restoD2 == 0 && restoD3 == 0) {
			mensagem = mensagem + "d: " + d + "\n";
		}
