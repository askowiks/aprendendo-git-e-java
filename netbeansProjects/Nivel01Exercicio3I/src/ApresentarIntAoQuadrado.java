...
public class ApresentarIntAoQuadrado {

	public static void main(String[] args) {
// </editor-fold>
		// Your code starts here :)
		
//Passo 1: Ler o numero inteiro
		Integer numero = readWindowInteger("Digite um valor numérico inteiro");
		
//Passo 2: Calcular o valor ao quadrado
		Integer quadrado = (numero * numero);

//Passo 3: Exibir os dados
		writeWindow("   Valor digitado: " + numero +
