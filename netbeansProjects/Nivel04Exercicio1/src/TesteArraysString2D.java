...
public class TesteArraysString2D {
...
// </editor-fold>
	...
	String mensagem = "";
		...
		for (int indice1 = 0; indice1 < nomes.length; indice1++) {
			for (int indice2 = 0; indice2 < nomes.length; indice2++) {
				nomes[indice1] [indice2] = readString("Digite o nome");
				mensagem += nomes [indice1][indice2] + ", ";
			}
		}
		
		write("Esses são os nomes digitados:\n" + mensagem);
