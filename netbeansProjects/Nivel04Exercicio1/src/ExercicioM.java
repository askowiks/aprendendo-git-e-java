...
// </editor-fold>
		...
		/*
Construir um programa que calcule a tabuada de um valor qualquer de 1 até 10 e
armazene os resultados em uma matriz A de uma dimensão. Apresentar os elementos
da matriz A.
		 */
		Integer numero = readInteger("Digite o número para calcular a tabuada");
		Integer[] matrizA = new Integer[10];
		Integer multiplicador = 1;
		
		for (int indice = 0; indice < matrizA.length; indice++) {
			matrizA[indice] = numero * multiplicador;
			
			write(numero + " x " + multiplicador + " = " + matrizA[indice]);
