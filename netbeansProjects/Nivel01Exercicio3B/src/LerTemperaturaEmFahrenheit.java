...
public class LerTemperaturaEmFahrenheit {

	public static void main(String[] args) {
// </editor-fold>
		// Your code starts here :)
		
		//Passo 1: Ler o valor em Fahrenheit
		Double fahrenheit = readWindowDouble("Digite a temperatura em Fahrenheit");
		
		//Passo 2: Calcular a conversão
		Double celsius = ((fahrenheit - 32.0) * 5.0) / 9.0;
		
		//Passo 3: Exibir conversão para Celsius

		writeWindow("A temperatura em Celsius é " + celsius + "º");
