...
//PASSO 1: LER OS VALORES EM REAL E EM DOLAR
	Double dolar = readWindowDouble("Digite o valor a ser convertido (Dolar US$)");
	Double real = readWindowDouble("Digite o valor da cotação do Dolar hoje");
	

//PASSO 2: CALCULAR A CONVERSÃO
	Double conversao = real * dolar;

//PASSO3: EXIBIR VALORES E RESULTADO
		writeWindow("Valor a ser convertido:  US$ " + dolar +
					"\nCotação do Dolar atual:  R$ " + real +
					"\n      Valor convertido:  R$ " + conversao 
		);
