...
public class SomaDosNumerosAoQuadrado {
...
// </editor-fold>
	...
	// PASSO 1: LER AS VARIAVEIS A,B,C
		Integer  a, b, c;
		...
		// PASSO 2: CALCULAR A SOMA DOS QUADRADOS
		Integer soma = a + b + c;
		
		Double quadSoma = Math.pow(soma, 2);
		
				
		// PASSO 3: EXIBIR RESULTADOS
		writeWindow("A soma dos números ao quadrado é: " + quadSoma);
