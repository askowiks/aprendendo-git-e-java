...
// </editor-fold>
		...
		//Passo 1: Ler as variaveis (TEMPO e velocidade) e calcular a distancia.
		Double tempo = readWindowDouble("Digite o tempo da viagem em horas");
		Double velocidade = readWindowDouble("Digite a velocidade média (Km/h)");
		Double distancia = tempo * velocidade ;
		
		//Passo 2: Calcular consumo de combustivel
		Double combustivel = distancia / 12 ;
		
		//Passo 3: Exibir (velocidade média, tempo gasto, distancia porcorrida e quantidade de litros gasto)
		writeWindow("       Velocidade média: " + velocidade + "Km/h" +
