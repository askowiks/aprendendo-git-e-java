...
// </editor-fold>
		...
		writeWindow("Calculo de volume retangular");
		//Passo 1: Ler o valores de altura, largura e comprimento.
		Double altura = readWindowDouble("Digite a altura em metros");
		Double largura = readWindowDouble("Digite o valor da largura em metros");
		Double comprimento = readWindowDouble("Digite o comprimento em metros");
		
		//Passo 2: Calcular o volume.
		Double volume = comprimento * largura * altura;
		
		//Passo 3: Exibir volume
		writeWindow("O volume é: " + volume + "m³");
