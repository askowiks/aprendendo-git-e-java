...
//		
//		while (cont <= 15) {
//			num = readInteger("Digite um valor");
//			write(num);
//			cont++;
//		}
//PASSO 2 - CONTAGEM REGRESSIVA
//		Integer num = readInteger("Digite um numero para contagem regressiva");
//		Integer cont = num;
//		
//		while (cont >= 1) {
//			write(cont);
...
//			cont--;
//		}
//PASSO 3 - CALCULAR FATORIAL
//	Integer numFatorial = readInteger("Digite o numero");
//	Integer cont = numFatorial;
//	Integer resultFatorial = 1;
//	
//	while (cont >= 1) {
//			write(cont);
//			
...
//SOLUÇÃO FINAL
		Integer contNumLido = 0;
		Integer num = 0;

		while (contNumLido < 15) {
			num = readInteger("Digite um valor");
			//CALCULO DO FATORIAL
			Integer numFatorial = num;
			Integer contFatorial = numFatorial;
			Integer resultFatorial = 1;

			while (contFatorial >= 1) {

				resultFatorial = resultFatorial * contFatorial;
				contFatorial--;
			}
			write(resultFatorial);
