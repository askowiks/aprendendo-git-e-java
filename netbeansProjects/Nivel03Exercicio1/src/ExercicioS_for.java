...
representando o dividendo e o divisor da divisão a ser processada. Sugestão: para a elaboração do 
programa, não utilize o operador aritmético de divisão com quociente inteiro DIV. Use uma solução baseada 
em laço. O programa deve apresentar como resultado (quociente) quantas vezes o divisor cabe no 
dividendo.
		 */

Integer quociente = 0;
Integer dividendo = readInteger("digite o valor do dividendo");
Integer divisor = readInteger("digite o valor do divisor");


		for ( ; divisor <= dividendo; ) {
