...
public class ExercicioA_doWhilePretty {
...
//Quebra de linha a cada 10 e adicionar virgula
			if (contLinha == 10) {
				mensagem += (int) Math.pow(cont, 2) + ", \n";
				contLinha = 0;
			} 
//Não quebrar linha e colocar virgula
			else {
			//Remover virgula do ultimo elemento
				if (cont == 200) {
					mensagem += (int) Math.pow(cont, 2);
				} 
			//Colocar virgula
