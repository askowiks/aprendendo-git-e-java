...
public class testesForJava {

	public static void main(String[] args) {
// </editor-fold>
		// Your code starts here :)

		Integer qtdEstrelas = readWindowInteger("Quantas estrelas você quer ver?");

		String estrelas = "";

		for (int cont = 0; cont < qtdEstrelas; cont++) {
			estrelas = estrelas + "*";
		}
	
		writeWindow(estrelas);
