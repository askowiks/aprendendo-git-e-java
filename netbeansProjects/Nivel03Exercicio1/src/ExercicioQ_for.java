...
public class ExercicioQ_for {

	public static void main(String[] args) {
// </editor-fold>
		// Your code starts here :)
/*
Escrever um programa que possibilite calcular a área total em metros de uma residência com os cômodos
...
"NÃO", o programa deve apresentar o valor total acumulado da área residencial
		 */

String comodo = "";
Double largura = 0.0;
Double altura = 0.0;
Double areaComodo = 0.0;
Double areaTotal = 0.0;
String continuar = "sim";

		
		for ( ;continuar.equals("sim"); ) {
			
		comodo = readString("digite o nome do comodo");
		largura = readDouble("Digite a largura em metros");
		altura = readDouble("digite a altura em metros");
		
		areaComodo = largura * altura;
		areaTotal += areaComodo;
		
		continuar = readString("Deseja calcular outro comodo?");
		}

		
			
	write("Área dos comodos: " + areaTotal + " m²");
