...
public class ExercicioN_while {

	public static void main(String[] args) {
// </editor-fold>
		// Your code starts here :)
/*
Elaborar um programa que leia sucessivamente valores numéricos e apresente no final o somatório, a média 
...
positivos. Ou seja, o programa deve parar quando o usuário fornecer um valor negativo (menor que zero)
		...
		while (numero >= 0) {
			numero = readDouble("Digite um numero");
			//Calcular somatoria
			if (numero >= 0) {
				soma = soma + numero;
				qtdNumeros++;
		...
		write("Somatória: " + soma + "\nMédia: " + media + "\nQuantidade de números: " + qtdNumeros);
