...
public class ExercicioK_while {

	public static void main(String[] args) {
// </editor-fold>
		// Your code starts here :)

//calcular a somatoria (dobro do anterior) inicando em 01 (quadro 01) terminando em quadro 60.
//PARTE 01 - 
//	Integer fim = 64;
//	Integer contador = 1;
//	
...
//		}
		...
		//executando a 1ª casa do xadrez
		grao = grao + 1;
		soma = soma + grao;
		write("contator: " + contador + "\nGrão: " + grao + "\nSoma: " + soma);
		contador++;

		//executando demais casas do xadrez
		while (contador <= fim) {
			grao = grao + grao;
