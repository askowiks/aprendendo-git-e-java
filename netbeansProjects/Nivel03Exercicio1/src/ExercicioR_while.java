...
public class ExercicioR_while {

	public static void main(String[] args) {
// </editor-fold>
		// Your code starts here :)
/*
 Elaborar um programa que leia valores positivos inteiros até que um valor negativo seja informado.
...
Integer menor = Integer.MAX_VALUE;
		...
		while (numero >= 0) {
			numero = readInteger("digite um valor");
