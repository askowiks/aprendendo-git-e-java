...
public class ConversaoVelsiusParaFahrenheit {
...
// </editor-fold>
	...
	//Passo 1: Ler o valor em Celsius do usuario
	Double celsius = readWindowDouble("Digite a temperatura atual em Celsius");
	
	//Passo 2: Calcular a conversão
	Double fahrenheit = (9.0 * celsius + 160.0) / 5.0;
	
	//Passo 3: Exibir a conversão para Fahrenheit
		writeWindow("A temperatura em Fahrenheit é " + fahrenheit + "º");
