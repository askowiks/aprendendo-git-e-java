...
public class DiferencaABQuadrado {
...
// </editor-fold>
		...
		//Passo 1: ler A e B
		Integer a,b;
		a = readInteger("Digite o valor de A");
		b = readInteger("Digite o valor de B");
		
		//Passo 2: calcular o quadrado da diferença
		Integer diferenca = a - b;
		Double quadrado = Math.pow(diferenca, 2);
		Integer resultado = quadrado.intValue();
		
		//Passo 3: exibir cálculo
		write("Resultado do Quadrado da Diferença: " + resultado);
