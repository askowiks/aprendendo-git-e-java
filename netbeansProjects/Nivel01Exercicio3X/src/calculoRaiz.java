...
//PASSO 1: LER A BASE DA RAIZ
	Double base = readWindowDouble("Digite o valor da base da raiz");
	Double indice = readWindowDouble("Digite o valor do índice da raiz");


//PASSO 2: CALCULAR RAIZ
	Double resultado = Math.pow(base, (1.0/indice));

//PASSO 3: EXIBIR RESULTADO
		writeWindow("O resultado da radiciação é: " + resultado);
