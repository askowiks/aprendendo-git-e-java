...
/*
			Passo 01: Ler valor do raio (R)
			Passo 02: Calcula a àrea ==> A = (3.14159265 * R) ^ 2
			Passo 03: Exibir valor da àrea
		*/
		...
		//Passo 02
		Double area = 3.14159265 * (raio*raio);
		
		//Passo 03
		writeWindow("O valor da àrea do círculo é: " + area);
