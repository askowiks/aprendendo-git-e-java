...
lembrando que um pé́mede 0,3048 metro, ou seja, um pé́é igual a 30,48 centímetros.
		*/
//PASSO 1: LER A MEDIDA EM PÉS
	Double pes = readWindowDouble("Digite a media em pés");


//PASSO 2: CONVERTER A MEDIDA EM PÉS PARA CM => convers = pés * 0.3048.
	Double conversao = pes * 0.3048 ;
	
//PASSO 3: EXIBIR RESULTADO
		writeWindow("RESULTADO DA CONVERSÃO\n \n" +
					pes + " pés = " + conversao + " metros");
