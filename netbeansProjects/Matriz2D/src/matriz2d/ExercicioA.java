...
// </editor-fold>
	...
	com cinco linhas e três colunas para valores inteiros. Construir uma matriz
	C de mesma dimensão, que seja formada pela soma dos elementos da matriz A com
	os elementos da matriz B. Apresentar os elementos da matriz C.
		 */
		int qtdeLinhas = 5;
		int qtdeColunas = 3;
		Integer[][] matrizA = new Integer[qtdeLinhas][qtdeColunas];
		Integer[][] matrizB = new Integer[qtdeLinhas][qtdeColunas];
		Integer[][] matrizC = new Integer[qtdeLinhas][qtdeColunas];
		String msg = "";
		...
		for (int linha = 0; linha < matrizA.length; linha++) {
			...
			for (int coluna = 0; coluna < matrizA[linha].length; coluna++) {
				matrizA[linha][coluna] = readInteger("Digite um número [A]");

				msg += "| " + matrizA[linha][coluna] + " ";
			}
		}
		msg += "\n \n";
		...
		for (int linha = 0; linha < matrizA.length; linha++) {
			...
			for (int coluna = 0; coluna < matrizB[linha].length; coluna++) {
				matrizB[linha][coluna] = readInteger("Digite um número [B]");
				msg += "| " + matrizB[linha][coluna] + " ";
			}

		}
		msg += "\n \n";

		//ATRIBUIÇÃO MATRIZ[C] = SOMA DOS ELEMENTOS DE [A] E [B]
		msg += "Matriz[C] -> [A] + [B]:\n";
		for (int linha = 0; linha < matrizA.length; linha++) {

			for (int coluna = 0; coluna < matrizC[linha].length; coluna++) {
				matrizC[linha][coluna] = matrizA[linha][coluna] + matrizB[linha][coluna];
				msg += "| " + matrizC[linha][coluna] + " ";
			}
