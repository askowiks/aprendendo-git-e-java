...
// </editor-fold>
		...
		//Passo 1: Ler variaveis de VALOR, TAXA e TEMPO
		Double valor = readWindowDouble("Digite o valor da parcela");
		Double taxa = readWindowDouble("Digite a taxa de juros");
		Double tempo = readWindowDouble("Digite o tempo de atraso (em meses)");
		
		//Passo 2: Calcula o valor da parcela
		Double prestacao = valor + (valor * (taxa/100) * tempo);
				
		
		//Passo 3: Exibir o valor da parcela em atraso
		writeWindow("O valor atualizado da prestação é R$ " + prestacao);
