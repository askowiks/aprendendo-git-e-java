...
public class CalculoDoReajusteSalario {

	public static void main(String[] args) {
// </editor-fold>
		// Your code starts here :)
	/*
	Passo 01: Ler o salario e a porcentagem do reajuste
	Passo 02: Calcular o reajuste
	Passo 03:mostrar o salario + reajuste
	*/
	
	//Passo 01
	Double salario = readWindowDouble("Digite o valor do Salário");
	Double pReajuste = readWindowDouble("Digite a porcentagem do ajuste (apenas numeros)");
	
	//Passo 02
	Double valorReajuste = (salario * pReajuste) / 100;
	Double salarioNovo = salario + valorReajuste;
	
	//Passo 03
		writeWindow(
				"Reajuste salarial\n \n" +
				"Salário base: R$ " + salario + "\n" +
				"Porcentagem do reajuste: " + pReajuste + "%\n" +
				"Valor do reajute: R$ " + valorReajuste + "\n" +
