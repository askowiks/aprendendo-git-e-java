...
//PASSO 1: LER OS VALORES EM REAL E EM DOLAR
	Double real = readWindowDouble("Digite o valor a ser convertido (Real R$)");
	Double dolar = readWindowDouble("Digite o valor da cotação do Dolar hoje");
...
//PASSO3: EXIBIR VALORES E RESULTADO
		writeWindow("Valor a ser convertido:  R$ " + real +
					"\nCotação do Dolar atual:  R$ " + dolar +
