...
//PASSO 01: LER VARIÁVEIA "A" E "B"
	Double a = readWindowDouble("Digite o valor de A");
	
	Double b = readWindowDouble("Digite o valor de B");


//PASSO 02: CALCULAR AS QUATRO OPERAÇÕES (+ - * /)
	Double somaAB = a + b;
	Double subtAB = a - b;
	Double multAB = a * b;
	Double diviAB = a /b ;
...
//PASSO 03: EXIBIR RESULTADOS POSSÍVEIS.
		writeWindow("RESULTADOS POSSÍVEIS \n \n" +
					"A: " + a + "\n" +
					"B: " + b + "\n \n" +
					"A+b: " + somaAB + "\n" +
					"A-b: " + subtAB + "\n" +
