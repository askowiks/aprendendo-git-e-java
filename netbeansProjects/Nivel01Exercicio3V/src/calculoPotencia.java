...
/*
Elaborar um programa que leia dois valores numéricos inteiros, os quais devem representar a base e o
expoente de uma potência, calcule a potência e apresente o resultado obtido
		*/
//PASSO 1: LER VARIAVEIS (BASE E EXPOENTE)
	Integer base = readWindowInteger("Digite o valor da base da exponenciação");
	Integer expoente = readWindowInteger("Digite o valor do expoente");

//PASSO 2: CALCULAR POTENCIA.
	Double resultado = Math.pow(base, expoente);

//EXIBIR VARS E RESULTADO
		writeWindow("RESUTADO DA EXPONENCIAÇÃO\n \n" +
